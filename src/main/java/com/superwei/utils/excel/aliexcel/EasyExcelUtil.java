package com.superwei.utils.excel.aliexcel;
...
public class EasyExcelUtil {
    ...
    public static List<Object> readExcel(MultipartFile excel, BaseRowModel rowModel, String sheetName,
        ...
        Workbook wb = getWorkbookMvc(excel);
        int sheetIndex = wb.getSheetIndex(sheetName);
        if(sheetIndex == -1){
            return null;
        }
        reader.read(new Sheet(sheetIndex+1, headLineNum, rowModel.getClass()));
        return excelListener.getDatas();
    }
    ...
    private static Workbook getWorkbookMvc(MultipartFile file) {
        ...
        try {
            ...
            if (fileName.endsWith(".xls")) { // 如果是2003版本
